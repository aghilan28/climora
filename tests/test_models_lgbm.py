"""Unit tests for LightGBM climate model."""
...
def test_lightgbm_fit_predict_save_load(gistemp_fixture_bytes: bytes, tmp_path) -> None:
    ...
    model = LightGBMClimateModel(params={"n_estimators": 10, "random_state": 42})
    ...
    model_reloaded = LightGBMClimateModel().load(tmp_path)
